...
<head>
    ...
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v7.0" nonce="Of1WlvyH"></script>
    <!-- Modernizr JS -->
                    ...
                    <div class="menumenu__container clearfix">
                        ...
                        <div class="col-md-7 col-lg-8 col-sm-5 col-xs-3">
                            <nav class="main__menu__nav hidden-xs hidden-sm">
                                <ul class="main__menu">
                                    <li class="drop"><a href="danh-sach-san-pham">Điện thoại</a>

                                    <li class="drop"><a href="#">Tablet</a>

                                    </li>
                                    <li class="drop"><a href="#">Phụ kiện</a>

                                    </li>
                                    <li class="drop"><a href="#">Đồng hồ</a>
                                    ...
                                    <li class="drop"><a href="#">Khuyến mại</a>
                        ...
                        <div class="col-md-3 col-lg-2 col-sm-4 col-xs-4">
                            <div class="header__right">
                                ...
                                <div class="htc__shopping__cart" href="carts/index.php">
                                    <a class="cart__menu" href="carts/index.php"><i class="icon-handbag icons"></i></a>
                                    <a href="carts/index.php"></a>
                                </div>
                            </div>
                        </div>
                    </div>
