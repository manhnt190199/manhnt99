...
<h1 style="text-align: center; font-family: Franchise; color: #8ad919;">Danh sách sản phẩm</h1>
        ...
        <?php foreach ($products as $product): ?>
            <tr>
                ...
                <td>
                    ...
                    <a title="Chi tiết" href="<?php echo $url_detail ?>" class="btn btn-success">Chi tiết</a> &nbsp;&nbsp;
                    <a title="Update" href="<?php echo $url_update ?>" class="btn btn-success">Cập nhật</a> &nbsp;&nbsp;
                    <a title="Xóa" href="<?php echo $url_delete ?>" onclick="return confirm('Are you sure delete?')" class="btn btn-success">
                        Xóa
                    </a>
                </td>
            </tr>
